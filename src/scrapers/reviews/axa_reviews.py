# Script Playwright pour capturer la partie basse de la page à partir de 'Avis de clients' (AXA)
...
def get_screenshot_path(product):
    ...
    screenshots_dir = os.path.join(base_dir, 'data', 'reviews_screenshots', 'axa')
...
if __name__ == "__main__":
    import sys
    # Usage: python axa_reviews.py [car|travel] [hauteur]
    product = 'travel'
    hauteur = 800
